export default function Register() {
    ...
    <div className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50">
        <div className="relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
            <div className="text-center text-3xl text-emerald-700 font-bold mb-8">Admin Registration</div>
            <form>
            <label htmlFor="name">Name</label>
            <input type="text" name="name" className="rounded-md ring-1 p-2 block my-2 ring-emerald-700 w-full" placeholder="name"/>
            ...
            <input type="password" name="password" className="rounded-md ring-1 p-2 block my-2 ring-emerald-700 w-full" placeholder="confirm password"/>
